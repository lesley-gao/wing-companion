      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 ">
              ...
              {tableOfContents.map((item, index) => (
                <li key={item.id} className="cursor-pointer list-none ">
                  <div
                    ...
                    className="text-gray-700 hover:text-blue-600 transition-colors text-left block w-full dark:text-white"
                  >
                    {index + 1}. {item.title}
                  </div>
                </li>
        ...
        <div className="lg:col-span-3">
          <div className="mb-8 ">
            ...
            <p className="text-gray-600 dark:text-white">Last updated: {lastUpdated}</p>
          </div>

          <div className="prose prose-lg max-w-none">
            <section className="mb-8" id="acceptance">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">1. Acceptance of Terms</h2>
            ...
            <section className="mb-8" id="description">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">2. Service Description</h2>
              <p className="text-gray-700 mb-4 dark:text-white">
            ...
            <section className="mb-8" id="eligibility">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">3. User Eligibility</h2>
              
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">3.1 Age Requirements</h3>
              <p className="text-gray-700 mb-4 dark:text-white">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">3.2 Identity Verification</h3>
              <p className="text-gray-700 mb-4 dark:text-white">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">3.3 Legal Compliance</h3>
              <p className="text-gray-700 dark:text-white">
            ...
            <section className="mb-8" id="accounts">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">4. User Accounts and Registration</h2>
              
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">4.1 Account Creation</h3>
              <p className="text-gray-700 mb-4 dark:text-white">
                To access our Service, you must create an account by providing accurate and complete information. 
                You are responsible for safeguarding your account credentials and for all activities that occur under your account.
              </p>

              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">4.2 Account Responsibilities</h3>
              <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-white">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">4.3 Account Suspension</h3>
              <p className="text-gray-700 dark:text-white">
            ...
            <section className="mb-8" id="conduct">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">5. User Conduct and Responsibilities</h2>
              
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">5.1 Prohibited Activities</h3>
              <p className="text-gray-700 mb-4 dark:text-white ">You agree not to:</p>
              <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-white">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">5.2 Safety Guidelines</h3>
              <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-white">
            ...
            <section className="mb-8" id="payments">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">6. Payment Terms and Conditions</h2>
              
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">6.1 Payment Processing</h3>
              <p className="text-gray-700 mb-4 dark:text-white">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">6.2 Service Fees</h3>
              <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-white">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">6.3 Refund Policy</h3>
              <p className="text-gray-700 dark:text-white">
            ...
            <section className="mb-8" id="liability">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">7. Limitation of Liability</h2>
              <p className="text-gray-700 mb-4 dark:text-white">
            ...
            <section className="mb-8" id="privacy">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">8. Privacy and Data Protection</h2>
              <p className="text-gray-700 mb-4 dark:text-white">
            ...
            <section className="mb-8" id="termination">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">9. Termination of Service</h2>
              
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">9.1 Termination by User</h3>
              <p className="text-gray-700 mb-4 dark:text-white">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-3 dark:text-white">9.2 Termination by Platform</h3>
              <p className="text-gray-700 dark:text-white">
            ...
            <section className="mb-8" id="changes">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">10. Modifications to Terms</h2>
              <p className="text-gray-700 mb-4 dark:text-white">
            ...
            <section className="mb-8" id="governing">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">11. Governing Law</h2>
              <p className="text-gray-700 dark:text-white">
            ...
            <section className="mb-8" id="contact">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">12. Contact Information</h2>
              <p className="text-gray-700 mb-4 dark:text-white">
