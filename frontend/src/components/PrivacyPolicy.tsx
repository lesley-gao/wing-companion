...
const PrivacyPolicy: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-20">
      ...
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-300 mb-4">Privacy Policy</h1>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8" id="information-we-collect">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">2. Information We Collect</h2>
          
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">2.1 Personal Information</h3>
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">2.2 Travel and Location Information</h3>
          <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">2.3 Payment Information</h3>
          <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">2.4 Communication Data</h3>
          <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">2.5 Technical Information</h3>
          <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8" id="how-we-use">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">3. How We Use Your Information</h2>
          
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">3.1 Core Service Functions</h3>
          <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">3.2 Safety and Security</h3>
          <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">3.3 Service Improvement</h3>
          <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8" id="information-sharing">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">4. Information Sharing and Disclosure</h2>
          
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">4.1 With Other Users</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">4.2 Service Providers</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-4">We may share information with trusted third parties who assist us in:</p>
          <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-300">
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">4.3 Legal Requirements</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-4">We may disclose information when required by law or to:</p>
          <ul className="list-disc pl-6 mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8" id="data-security">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">5. Data Security</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section className="mb-8" id="privacy-rights">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">6. Your Privacy Rights</h2>
          
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">6.1 Access and Control</h3>
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">6.2 Location Services</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">6.3 Marketing Communications</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section className="mb-8" id="data-retention">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">7. Data Retention</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section className="mb-8" id="international-transfers">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">8. International Data Transfers</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section className="mb-8" id="children-privacy">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">9. Children's Privacy</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section className="mb-8" id="third-party-services">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">10. Third-Party Services</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section className="mb-8" id="policy-changes">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">11. Changes to This Privacy Policy</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section className="mb-8" id="contact-us">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <p className="text-gray-700 dark:text-gray-900 mb-2"><strong>Email:</strong> privacy@flightcompanion.com</p>
            <p className="text-gray-700 dark:text-gray-900 mb-2"><strong>Address:</strong> [Your Company Address]</p>
            <p className="text-gray-700 dark:text-gray-900"><strong>Phone:</strong> [Your Contact Number]</p>
          </div>
        </section>

        <section className="mb-8" id="regional-rights">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">13. Regional Privacy Rights</h2>
          
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">13.1 GDPR (European Union)</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">13.2 CCPA (California)</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
