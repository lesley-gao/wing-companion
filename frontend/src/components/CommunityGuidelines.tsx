    ...
    <div className="max-w-7xl mx-auto px-6 py-20">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3">
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-300 mb-4">Community Guidelines</h1>
            <p className="text-gray-600 dark:text-gray-300">Last updated: {lastUpdated}</p>
          </div>

          <div className="prose prose-lg max-w-none">
            <section className="mb-8" id="overview">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">1. Community Overview</h2>
            ...
            <section className="mb-8" id="conduct">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">2. Code of Conduct</h2>
              
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">2.1 Respectful Communication</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">2.2 Zero Tolerance for Discrimination</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">2.3 Harassment Prevention</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8" id="safety">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">3. Safety Guidelines</h2>
              
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">3.1 Identity Verification</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">3.2 Safe Meeting Practices</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">3.3 Personal Information Protection</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8" id="services">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">4. Service Standards</h2>
              
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">4.1 Reliability and Commitment</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">4.2 Payment and Financial Conduct</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">4.3 Service Quality Standards</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8" id="reporting">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">5. Reporting and Enforcement</h2>
              
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">5.1 Reporting Violations</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">5.2 Investigation Process</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8" id="consequences">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">6. Consequences of Violations</h2>
              
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">6.1 Warning System</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">6.2 Account Restrictions</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">6.3 Account Termination</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium text-gray-800 dark:text-gray-300 mb-3">6.4 Appeals Process</h3>
              <p className="text-gray-700 dark:text-gray-300">
